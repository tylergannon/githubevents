...
func TestOnMetaEventAny(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				[]MetaEventHandleFunc{
					func(ctx context.Context, deliveryID string, eventName string, event *github.MetaEvent) error {
						return nil
					},
				},
			},
...
func TestSetOnMetaEventAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g.SetOnMetaEventAny(func(ctx context.Context, deliveryID string, eventName string, event *github.MetaEvent) error {
				return nil
			})
...
func TestHandleMetaEventAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := g.handleMetaEventAny(ctx, tt.args.deliveryID, tt.args.deliveryID, tt.args.event); (err != nil) != tt.wantErr {
...
func TestMetaEvent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := g.MetaEvent(ctx, tt.args.deliveryID, tt.args.eventName, tt.args.event); (err != nil) != tt.wantErr {
