...
type TeamAddEventHandleFunc func(ctx context.Context, deliveryID string, eventName string, event *github.TeamAddEvent) error
...
func (g *EventHandler) handleTeamAddEventAny(ctx context.Context, deliveryID string, eventName string, event *github.TeamAddEvent) error {
	if event == nil {
...
func (g *EventHandler) TeamAddEvent(ctx context.Context, deliveryID string, eventName string, event *github.TeamAddEvent) error {
	...
	err = g.handleTeamAddEventAny(ctx, deliveryID, eventName, event)
	if err != nil {
		return g.handleError(deliveryID, eventName, event, err)
	}
