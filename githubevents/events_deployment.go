...
type DeploymentEventHandleFunc func(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentEvent) error
...
func (g *EventHandler) handleDeploymentEventAny(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentEvent) error {
	if event == nil {
...
func (g *EventHandler) DeploymentEvent(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentEvent) error {
	...
	err = g.handleDeploymentEventAny(ctx, deliveryID, eventName, event)
	if err != nil {
		return g.handleError(deliveryID, eventName, event, err)
	}
