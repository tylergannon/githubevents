...
type DeploymentStatusEventHandleFunc func(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentStatusEvent) error
...
func (g *EventHandler) handleDeploymentStatusEventAny(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentStatusEvent) error {
	if event == nil {
...
func (g *EventHandler) DeploymentStatusEvent(ctx context.Context, deliveryID string, eventName string, event *github.DeploymentStatusEvent) error {
	...
	err = g.handleDeploymentStatusEventAny(ctx, deliveryID, eventName, event)
	if err != nil {
		return g.handleError(deliveryID, eventName, event, err)
	}
