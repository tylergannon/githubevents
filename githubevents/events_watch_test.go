	...
	}{
		{
			...
			args: args{
				[]WatchEventHandleFunc{
					func(ctx context.Context, deliveryID string, eventName string, event *github.WatchEvent) error {
						return nil
					},
				},
			},
...
func TestSetOnWatchEventAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			g.SetOnWatchEventAny(func(ctx context.Context, deliveryID string, eventName string, event *github.WatchEvent) error {
				return nil
			})
...
func TestHandleWatchEventAny(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := g.handleWatchEventAny(ctx, tt.args.deliveryID, tt.args.deliveryID, tt.args.event); (err != nil) != tt.wantErr {
...
func TestWatchEvent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := g.WatchEvent(ctx, tt.args.deliveryID, tt.args.eventName, tt.args.event); (err != nil) != tt.wantErr {
